        ...
        **Prezado(a) colaborador(a),**
        ...
        with st.form("form_avaliacao", clear_on_submit=True):
            ...
            transporte_nota = st.radio(
                ...
                horizontal=True, index=None, index=None,
                key="transporte_nota",
            )
            ...
            if submitted:
                if transporte_nota is None or portaria_nota is None or vigilancia_nota is None or limpeza_nota is None or jardinagem_nota is None or refeicao_nota is None:
                    st.error("Preencha todas as perguntas antes de enviar.")
                elif not estado:
